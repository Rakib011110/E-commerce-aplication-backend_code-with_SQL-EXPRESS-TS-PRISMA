...
exports.default = {
    ...
    jwt: {
        ...
        resetPasswordTokenSecret: process.env.RESET_PASS_TOKEN || "default_reset_secret",
        resetPasswordTokenExpiresIn: process.env.RESET_PASS_TOKEN_EXPIRES_IN || "5m",
    },
    // Email Configuration
    email: {
    ...
    // Reset Password Link
    resetPasswordLink: process.env.RESET_PASS_LINK || "http://localhost:5000/reset-password",
    // Payment Gateway
    paymentGateway: {
        ...
        paymentApiUrl: process.env.SSL_PAYMENT_API || "https://api.paymentgateway.com",
        validationApiUrl: process.env.SSL_VALIDATIOIN_API || "https://api.paymentvalidation.com",
    },
};
